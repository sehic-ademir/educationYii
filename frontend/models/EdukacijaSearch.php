...
/**
 * EdukacijaSearch represents the model behind the search form of `common\models\Edukacije`.
 */
class EdukacijaSearch extends Edukacije
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['lecturer', 'lecture_title', 'lecture_date', 'lecture_time'], 'safe'],
        ];
    }
